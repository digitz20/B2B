...
const FindEmailsByCriteriaOutputSchema = z.object({
  ...
  reasoning: z.string().optional().describe("Explanation of the companies, individuals, and email addresses found related to the search criteria. Include how many emails were found and if the target of 1000+ was met, explain limitations or how breadth was achieved if it wasn't."),
});
